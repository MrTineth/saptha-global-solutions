        ...
        <section class="feature-sec10 ibt-section-gap">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="feature-card10">
                            <img src="assets/images/service/ui.gif" alt="service image 2">
                            <h4 class="title">Modern<br />UI/UX Design</h4>
                            <p>We design clean and user friendly digital experiences.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="feature-card10">
                            <img src="assets/images/service/seo.gif" alt="service image 9">
                            <h4 class="title">Search Engine <br />Optimization</h4>
                            <p>We increase visibility through search engine growth.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="feature-card10">
                            <img src="assets/images/service/socail.gif" alt="service image 12">
                            <h4 class="title">Socail Media<br />Marketing</h4>
                            <p>We grow your brand through social media channels.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="feature-card10">
                            <img src="assets/images/service/security.gif" alt="service image 13">
                            <h4 class="title">Cyber Security<br />Services</h4>
                            <p>We protect your systems from digital threats.</p>
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="feature-card10">
                            <img src="assets/images/service/devops.gif" alt="service image 14">
                            <h4 class="title">DevOps Automation<br />Tools</h4>
                            <p>We speed delivery using smart automation tools.</p>
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="feature-card10">
                            <img src="assets/images/service/iot.gif" alt="service image 15">
                            <h4 class="title">IoT System<br />Solutions</h4>
                            <p>We connect devices through smart IoT systems.</p>
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="feature-card10">
                            <img src="assets/images/service/hardware.gif" alt="service image 16">
                            <h4 class="title">Hardware Solution<br />Services</h4>
                            <p>We supply and manage reliable hardware systems.</p>
                        </div>
                    </div>
                </div>
            </div>
